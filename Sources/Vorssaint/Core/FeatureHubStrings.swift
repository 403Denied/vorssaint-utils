...
extension FeatureHubStrings {
    static let enUS = FeatureHubStrings(
        ...
        descWindowLayout: "Snap windows into halves, thirds and corners",
    ...
    static let ptBR = FeatureHubStrings(
        ...
        descWindowLayout: "Encaixe janelas em metades, terços e cantos",
    ...
    static let tr = FeatureHubStrings(
        ...
        descWindowLayout: "Pencereleri yarıya, üçte bire ve köşelere yerleştirin",
    ...
    static let ru = FeatureHubStrings(
        ...
        descWindowLayout: "Раскладывайте окна по половинам, третям и углам",
    ...
    static let es = FeatureHubStrings(
        ...
        descWindowLayout: "Encaja ventanas en mitades, tercios y esquinas",
    ...
    static let de = FeatureHubStrings(
        ...
        descWindowLayout: "Fenster in Hälften, Drittel und Ecken einrasten",
    ...
    static let fr = FeatureHubStrings(
        ...
        descWindowLayout: "Rangez les fenêtres en moitiés, tiers et coins",
    ...
    static let it = FeatureHubStrings(
        ...
        descWindowLayout: "Incastra le finestre in metà, terzi e angoli",
    ...
    static let ja = FeatureHubStrings(
        ...
        descWindowLayout: "ウインドウを半分、三分割、隅に整列",
    ...
    static let zhHans = FeatureHubStrings(
        ...
        descWindowLayout: "把窗口贴靠到半屏、三分和角落",
    ...
    static let zhTW = FeatureHubStrings(
        ...
        descWindowLayout: "把視窗貼齊到半屏、三分和角落",
